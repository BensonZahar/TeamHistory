...
const jskOptions = [
    { name: "Lars_Osterman изменил должность на Светотехник [№2] в ТРК \'Ритм\'<t>2025-11-20 17:12:48<n>", action: "jsk_view" },
    { name: "Lars_Osterman принял в ТРК \'Ритм\' на должность Стажер [№1]<t>2025-11-20 16:39:20<n>", action: "jsk_view" },
    { name: "Ryuto_Yamada изменил должность на Подполковник [№8] в Мин. внутренних дел<t>2025-11-10 20:45:02<n>", action: "jsk_view" },
    { name: "Bruno_Castro изменил должность на Майор [№7] в Мин. внутренних дел<t>2025-11-03 21:47:03<n>", action: "jsk_view" },
    { name: "Ryuto_Yamada изменил должность на Капитан [№6] в Мин. внутренних дел<t>2025-11-02 21:25:40<n>", action: "jsk_view" },
    { name: "Bruno_Castro изменил должность на Лейтенант [№5] в Мин. внутренних дел<t>2025-10-31 20:34:22<n>", action: "jsk_view" },
